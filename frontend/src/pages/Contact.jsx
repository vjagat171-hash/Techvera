...
const Contact = () => {
  ...
  const services = [
    {
      ...
      icon: <FaLaptopCode />,
      desc: 'Business websites, landing pages, responsive portals and modern frontend experiences.',
    },
    {
      title: 'SEO Growth',
      icon: <FaSearch />,
      desc: 'Technical SEO, content structure, keyword visibility and local search optimization.',
    },
    {
      title: 'Performance Marketing',
      icon: <FaChartLine />,
      desc: 'Google Ads, Meta Ads, lead generation funnels and conversion-focused campaign strategy.',
    },
    {
      title: 'Business Audit',
      icon: <FaBullseye />,
      desc: 'Website, funnel, traffic and brand growth audit with practical recommendations.',
    },
  ];
  ...
  const contactCards = [
    {
      title: 'Email Us',
      value: 'hello@techvera.com',
      sub: 'Best for detailed project discussions',
      icon: <FaEnvelope />,
      href: 'mailto:hello@techvera.com',
    },
    {
      title: 'Call Us',
  ...
  const processSteps = [
    {
      ...
      desc: 'Share your business details, current bottleneck and project goals through the form.',
      icon: <FaPaperPlane />,
    },
    {
      step: '02',
      title: 'We Review Your Case',
      desc: 'We analyze your website, growth channels, offer positioning and conversion opportunities.',
      icon: <FaSearch />,
    },
    {
      step: '03',
      title: 'Strategy Discussion',
      desc: 'We connect with you for a focused consultation and recommend the right next steps.',
      icon: <FaUserTie />,
    },
    {
      step: '04',
      title: 'Execution Plan',
      desc: 'You receive a practical direction for website, SEO, ads or complete growth implementation.',
      icon: <FaRocket />,
    },
  ];
  ...
  const benefits = [
    {
      title: 'Fast Response',
      desc: 'We aim to review and respond to serious project inquiries quickly.',
      icon: <FaClock />,
    },
    {
      title: 'Confidential Discussion',
      desc: 'Your business data, goals and challenges stay private and secure.',
      icon: <FaShieldAlt />,
    },
    {
      title: 'Multi-Service Support',
      desc: 'Web development, SEO, ads and business growth support in one place.',
      icon: <FaHeadset />,
    },
  ];
  ...
  const faqs = [
    {
      ...
      a: 'We review your information, understand the requirement and reach out with the next step or consultation schedule.',
    },
    {
      q: 'Can I contact you for website development only?',
      a: 'Yes, you can contact us for websites, SEO, ads, audits or complete digital growth support.',
    },
    {
      q: 'Do I need to have a website already?',
      a: 'No, you can contact us even if you are starting from scratch and need strategy plus development.',
    },
    {
      q: 'Is my information safe?',
      a: 'Yes, the page clearly communicates confidentiality and your submitted details are meant only for project communication.',
    },
  ];

  const quickTopics = [
    'Need a new business website',
    'Website redesign and speed improvement',
    'Want more leads from Google',
    'Need SEO support',
    'Running ads but poor ROI',
    'Need complete digital strategy',
  ];
      ...
      <section className="relative bg-gradient-to-br from-gray-950 via-blue-950 to-gray-900 text-white py-24 md:py-32 px-6 overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <a
              href="tel:+919876543210"
              className="border border-gray-500 hover:border-white text-white font-bold py-4 px-8 rounded-full text-lg transition"
            >
              Call Directly
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-600 mt-3 max-w-2xl mx-auto text-lg">
              Pick the communication method that fits your project urgency and style.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            {contactCards.map((item, index) => (
              <motion.a
                ...
                className="bg-gray-50 rounded-3xl border border-gray-100 p-7 shadow-sm hover:shadow-xl transition block"
              >
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6 mb-10">
            <div>
              ...
              <p className="text-gray-600 mt-3 max-w-2xl text-lg">
                Select a service area to quickly align your form with the right requirement.
              </p>
            </div>
            ...
            {filteredServices.map((item, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-blue-600 font-bold inline-flex items-center"
                >
                  Choose this service <FaArrowRight className="ml-2" />
                </button>
              </motion.div>
            ))}
          </div>
            ...
            <ul className="space-y-5 text-gray-700 font-medium">
              {processSteps.map((step) => (
                <li key={step.step} className="flex items-start">
                  <div className="w-11 h-11 rounded-2xl bg-blue-100 text-blue-600 flex items-center justify-center mr-4 flex-shrink-0">
                    {step.icon}
                  </div>
                  <div>
            ...
            <div className="space-y-5">
              {benefits.map((item) => (
                <div key={item.title} className="flex items-start">
                  <div className="bg-gray-800 p-3 rounded-2xl mr-4 text-white">
                    {item.icon}
                  </div>
                  <div>
          ...
          <div className="bg-white p-8 md:p-12 rounded-3xl shadow-2xl border border-gray-100 relative overflow-hidden">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Fill out the form and we will review your growth requirements, website needs or marketing goals.
              </p>
            </div>

            {status.msg && (
              <div
                className={`mb-8 p-4 rounded-xl font-semibold border ${
                  status.type === 'success'
              ...
              <div className="flex flex-wrap gap-2">
                {quickTopics.map((topic) => (
                  <button
                    ...
                    className="bg-blue-50 text-blue-700 border border-blue-100 px-3 py-2 rounded-full text-xs font-semibold hover:bg-blue-100 transition"
                  >
                    {topic}
                  </button>
                ))}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:bg-white transition"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:bg-white transition text-gray-700 font-medium"
                  >
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">
                  What is the biggest bottleneck in your growth right now? *
                </label>
                <textarea
                  name="message"
                  ...
                  required
                  rows="5"
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:bg-white transition resize-none"
                  placeholder="e.g. We have a website but no traffic, or our ads are burning money with no strong ROI..."
                />
              </div>
              ...
              <div className="bg-gray-50 border border-gray-100 rounded-2xl p-4 flex items-start">
                ...
                <p className="text-sm text-gray-600">
                  Your information is used only to review your request and contact you about relevant solutions.
                </p>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg py-4 rounded-xl shadow-[0_10px_20px_rgba(37,99,235,0.3)] transition duration-300 disabled:bg-blue-400 flex justify-center items-center"
              >
                {loading ? (
                  <div className="animate-spin h-6 w-6 border-t-2 border-b-2 border-white rounded-full mr-3"></div>
                ) : (
          ...
          {[
            {
              ...
              desc: 'Suitable for businesses needing websites, landing pages, SEO growth and performance campaigns.',
            },
            {
              icon: <FaCheckCircle />,
              title: 'Clarity Before Execution',
              desc: 'We first understand goals, bottlenecks and current digital gaps before suggesting execution.',
            },
            {
              icon: <FaBuilding />,
              title: 'Business-Oriented Communication',
              desc: 'The page is structured to collect meaningful project details, not just basic contact information.',
            },
          ].map((item, index) => (
            <motion.div
              key={item.title}
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-5xl mx-auto text-center bg-gradient-to-br from-gray-950 via-blue-950 to-gray-900 text-white rounded-[2rem] p-10 md:p-16 shadow-2xl">
          ...
          <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto mb-10">
            Share your business challenge today and start with a practical conversation around website, SEO, ads or digital growth.
          </p>
